...
when (k.KURZBEZ like 'DBK - Prüfung') THEN 'VAVE000032'
when (k.KURZBEZ like 'AB Prüfung') THEN 'VAVE000090'
when (SUBSTRING(k.NR,2,2) = 'E9' AND k.KURZBEZ like 'Bilanzbuchhalter/-in FLG 2015 (Anmeldung)') THEN 'VAVE000282'
when (SUBSTRING(k.NR,2,5) = 'INFOM' AND k.AUSSENST NOT IN ('Online','Online-Kurs')) THEN 'VAVT000028'
when (SUBSTRING(k.NR,2,3) = 'MAT') THEN 'VAVE000519'
when (SUBSTRING(k.NR,2,3) = 'XMT') THEN 'VAVT000031'

when (SUBSTRING(k.NR,2,5) = 'INFOM' AND k.AUSSENST IN ('Online','Online-Kurs')) THEN 'VAVT000029'
when (SUBSTRING(k.NR,2,2) = 'A1' AND k.KURZBEZ like 'Prüfung - Debitoren-/Kreditorenbuchhalter/in' AND k.AUSSENST NOT IN ('Online','Online-Kurs')) THEN 'VAVE000032'
when (SUBSTRING(k.NR,2,2) = 'A5' AND SUBSTRING(k.NR,2,2) = 'P') THEN 'VAVE000090'
when (k.NR like 'RXH9FL') THEN 'VAVE000478'
when (SUBSTRING(k.NR,2,2) = 'BA' AND k.KURZBEZ like 'Klausuren-Abschlusstraining' AND k.AUSSENST NOT IN ('online','Online','Online-Kurs')) THEN 'VAVE000071'
when (SUBSTRING(k.NR,2,4) = 'BAON' AND k.KURZBEZ like 'Klausuren-Abschlusstraining Online (virtuelles Klassenzimmer)') THEN 'VAVE000072'
...
when (SUBSTRING(k.NR,2,2) = 'A2' AND SUBSTRING(k.NR,8,1) = 'P') THEN 'VAVE000006'
...
when (SUBSTRING(k.NR,2,4) = 'A2VA') THEN 'VAVE000011'
when (k.KURZBEZ like 'Prüfung - Lohn und Gehaltsbuchhalter/in') THEN 'VAVE000017'
when (SUBSTRING(k.NR,2,2) = 'C5' AND k.AUSSENST in ('Online-Kurs')) THEN 'VAVE000083'
...
when (SUBSTRING(k.NR,2,2) = 'U8' AND SUBSTRING(k.NR,7,1) = '3' AND k.AUSSENST in ('Webinar')  ) THEN 'VAVE000229'
when (SUBSTRING(k.NR,2,4) = 'A1VA') THEN 'VAVE000280'
when (SUBSTRING(k.NR,2,4) = 'A5ON') THEN 'VAVE000020'
when (SUBSTRING(k.NR,2,2) = 'A7' AND k.KURZBEZ like 'Prüfung - Lohn und Gehaltsbuchhalter/in online') THEN 'VAVE000017'
when (SUBSTRING(k.NR,2,4) = 'A8ON' AND SUBSTRING(k.NR,7,1) = 'P') THEN 'VAVE000002'
when (SUBSTRING(k.NR,2,4) = 'A9ON' AND SUBSTRING(k.NR,7,1) = 'P') THEN 'VAVE000006'
...
when (SUBSTRING(k.NR,2,2) = 'PA' AND SUBSTRING(k.NR,6,2) = '15') THEN 'VAVE000496'
...
when (SUBSTRING(k.NR,2,4) = 'U8ON') THEN 'VAVE000232'
when (SUBSTRING(k.NR,2,2) = 'U8' AND k.AUSSTELL IN ('Webinar')) THEN 'VAVE000229'
when (SUBSTRING(k.NR,2,2) = 'XH') THEN 'VAVE000481'
...
when (k.KURZBEZ like '%Weiterbildung Bilanzbuchhalter/-in Zusatzqualifikation (IHK)%') THEN 'VAVE000481'
...
when (k.KURZBEZ like 'Master of Arts in Taxation - Infoveranstaltung%' AND k.AUSSTELL NOT IN ('Online','Online-Kurs','Online-Infoveranstaltung') AND k.NR not like 'VINFOMON%' AND k.NR not like 'WINFOMON%' AND k.NR not like 'UINFOMON%') THEN 'VAVT000028'
...
'NIX'
END
) = 'VAVA000025' and k.BEGINN_DAT >= '01.01.2015'  and k.KURZBEZ not like '%Ausfall%' and (k.FACHB not in ('OR', 'VE','X'))   
