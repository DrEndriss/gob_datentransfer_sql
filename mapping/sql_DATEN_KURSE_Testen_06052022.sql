...
when (SUBSTRING(k.NR,2,5) = 'INFOH' AND k.KURZBEZ like 'Bilanzbuchhaltung - International  - Online-Infoveranstaltung') THEN 'VAVE000494'
...
when (k.KURZBEZ like '%Bilanzbuchhalter International%' AND k.AUSSENST in ('Online-Kurs')) THEN 'VAVE000494'
...
when (k.NR  like '_BAON%' AND k.AUSSTELL IN ('Online','Online-Kurs')) THEN 'VAVE000072'
when (k.NR  like '_C5%') THEN 'VAVE000083'
when (k.NR  like '_A5%P' AND k.NR NOT LIKE 'VA5LS42P' AND k.NR NOT LIKE 'VA5LS92P') THEN 'VAVE000090'
...
'NIX'
END
) like 'VAVE000029' and k.BEGINN_DAT >= '01.01.2017' and k.KURZBEZ not like '%Ausfall%' and (k.FACHB not in ('OR', 'VE','X') AND k.NR like '%%') 
