...
when (SUBSTRING(k.NR,2,4) = 'AEVA') THEN 'VAVE000141'
when (SUBSTRING(k.NR,2,4) = 'AFVA') THEN 'VAVE000218'
when (SUBSTRING(k.NR,2,5) = 'INFOH' AND k.KURZBEZ like 'Bilanzbuchhaltung - International  - Online-Infoveranstaltung' AND k.KURZBEZ NOT like '%Online%') THEN 'VAVE000494'


when (k.NR like '%INFOH%' AND k.KURZBEZ like 'Internationale Rechnungslegung - Infoveranstaltung%' AND k.KURZBEZ NOT like '%Online%') THEN 'VAVE000494'
when (SUBSTRING(k.NR,2,2) = 'PA' AND SUBSTRING(k.NR,6,2) = 'C1') THEN 'VAVE000301'
when (SUBSTRING(k.NR,2,2) = 'PA' AND SUBSTRING(k.NR,6,2) = 'C3') THEN 'VAVE000182'
when (k.KURZBEZ like 'Finanzbuchhaltung mit SAP® S/4 HANA') THEN 'VAVE000572'
when (k.NR like '%PWONABOMZ') THEN 'VAVE000692'
...
'NIX'
END
) like '%VAVE000032%' and k.BEGINN_DAT >= '01.01.2017' and k.KURZBEZ not like '%Ausfall%' and (k.FACHB not in ('OR', 'VE','X') AND k.NR like '%%')
