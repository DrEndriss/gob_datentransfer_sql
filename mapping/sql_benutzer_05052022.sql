...
when (k.KURZBEZ like 'Abgabenordnung (Klausuren-Abschlusstraining Online)') THEN 'VAVE000065'
...
'NIX'
END
) like 'VAVE000065' and k.BEGINN_DAT >= '01.01.2015' and k.KURZBEZ not like '%Ausfall%' and (k.FACHB not in ('OR', 'VE','X') AND k.NR like '%%') 
