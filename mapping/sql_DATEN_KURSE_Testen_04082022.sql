...
when (k.NR like '%B8%') THEN 'VAVE000702' --passt
when ( (SUBSTRING(k.nr,2,2 ) = 'PD' AND SUBSTRING(k.nr,6,2 ) = '33') and k.DAUER <> '') THEN 'VAVE000703' --  Vorlagennummer schon vergeben
when (k.NR like '_A2___5%') THEN 'VAVE000494' -- passt
when (k.NR like '_B3___H') THEN 'VAVE000704'  -- Vorlagennummer schon vergeben
when (k.NR  like '_INFOB01%') THEN 'VAVE000708' -- passt
when (k.NR  like '_INFOB02%') THEN 'VAVE000706' -- passt 
when (k.NR  like '_G6ON_') THEN 'VAVE000709'  -- Vorlagennummer schon vergeben
when (k.NR  like '_INFOB03%') THEN 'VAVE000710' -- Vorlagennummer schon vergeben
when (k.NR  like '_H2ON%') THEN 'VAVE000497' -- Vorlagennummer schon vergeben
when (k.NR like '_H3ON%') THEN 'VAVE000711' -- Vorlagennummer schon vergeben
when (k.NR like '_INFOB04%') THEN 'VAVE000712' -- Vorlagennummer schon vergeben
when (k.NR  like '_INFOB05%') THEN 'VAVE000705' -- Vorlagennummer schon vergeben
when (k.NR  like '_INFOB06%') THEN 'VAVE000713' -- Vorlagennummer schon vergeben
when (k.NR  like '_PWONJ5%') THEN 'VAVE000714' -- Vorlagennummer schon vergeben
...
when (k.NR  like '_INFOB16%') THEN 'VAVE000715'  -- Vorlagennummer schon vergeben, findet aber die richigen Kurse
when (k.NR  like '%INFOB07%') THEN 'VAVE000716' -- Vorlagennummer schon vergeben, findet aber die richigen Kurse; Kennzeichen INFOB1 nicht INFOB7
when (k.NR like '%INFOB08%') THEN 'VAVE000717' -- passt
when (k.NR  like '%INFOB_9%') THEN 'VAVE000718' -- Vorlagennummer schon vergeben; kennzeiche INFOB_9, nicht INFOB9
when (k.NR  like '%INFOB10%') THEN 'VAVE000719' --Vorlagennummer schon vergeben 
when (k.NR  like '_INFOB11%') THEN 'VAVE000720' --Vorlagennummer schon vergeben 
when (k.NR  like '_INFOB12%') THEN 'VAVE000721' --Vorlagennummer schon vergeben 
when (k.NR  like '_PWONJ7%') THEN 'VAVE000722' --Vorlagennummer schon vergeben 
when (k.NR  like '_PWONJ6%') THEN 'VAVE000723' --Vorlagennummer schon vergeben 
when (k.NR like '_PWONJ8%') THEN 'VAVE000724' --Vorlagennummer schon vergeben
when (k.NR like '_PWONJ9%') THEN 'VAVE000725' --Vorlagennummer schon vergeben
when (k.NR  like '_PWONK1%') THEN 'VAVE000726' --Vorlagennummer schon vergeben
when (k.NR  like '_PWONK2%') THEN 'VAVE000727' --Vorlagennummer schon vergeben
when (k.NR  like '_INFOE01%') THEN 'VAVE000728' --Vorlagennummer schon vergeben
when (k.NR  like '_INFOB13%') THEN 'VAVE000232' --Vorlagennummer schon vergeben
when (k.NR  like '_INFOB14%') THEN 'VAVE000730' --Vorlagennummer schon vergeben

when (k.NR  like '_F3LS%') THEN 'VAVE000707' --passt
when (k.NR  like '_PB__12%') THEN 'VAVE000731' --passt 
when (k.NR  like '_PD__17%'  AND k.AUSSENST LIKE '%Web%') THEN 'VAVE000732' --passt
...
when (k.NR like '_PWONI6%') THEN 'VAVE000734' -- passt
when (k.NR  like '_PWONI7%') THEN 'VAVE000735' -- passt
when (k.NR  like '_PWONI8%') THEN 'VAVE000736' -- passt
when (k.NR  like '_PWONI9%') THEN 'VAVE000737' -- passt
when (k.NR  like '_PWONJ2%') THEN 'VAVE000738' -- passt
when (k.NR  like '_PWONJ3%') THEN 'VAVE000739' -- passt
when (k.NR  like '_PWONJ4%') THEN 'VAVE000740' -- passt
...
'NIX'
END
) like '%%' and k.BEGINN_DAT >= '01.01.2017' and (k.FACHB not in ('OR', 'VE','X') AND k.NR like '%WA7ON3P%')
