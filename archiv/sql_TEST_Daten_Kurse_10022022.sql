...
when ((substring(k.nr,2,2) = 'A2') AND (substring(k.nr,7,2)) = '3G') AND (k.AUSSENST in ('Video')) THEN 'VAVE000011'
...
when ((substring(k.nr,2,2) = 'A2') AND (substring(k.nr,7,2)) = '1F') AND (k.AUSSENST in ('Online', 'Online-Kurs') and (k.KURZBEZ not like '%Tageslehrgang%')) THEN 'VAVE000013'
...
when ((SUBSTRING(k.TITEL,1,27) = 'Klausuren-Abschlusstraining') AND k.AUSSTELL not in ('Online','Webinar','Online-Kurs')) THEN 'VAVE000071' --Klausuren-Abschlusstraining 
when ((SUBSTRING(k.TITEL,1,27) = 'Klausuren-Abschlusstraining') AND k.AUSSTELL  in ('Online','Webinar','Online-Kurs')) THEN 'VAVE000072' --Klausuren-Abschlusstraining-Online 

when (k.TITEL like '%Abgabenordnung (Klausuren-Abschlusstraining)%') THEN 'VAVE000065' --Abgabenordnung-Klausuren-Abschlusstraining-Online 
when (k.TITEL like '%Bilanzsteuerrecht 1 (Klausuren-Abschlusstraining)%' and SUBSTRING(k.nr,1,5) = 'WBAON') THEN 'VAVE000066' --Bilanzstuerrecht1-Klausuren-Abschlusstraining-Online 
when (k.TITEL like '%Bilanzsteuerrecht 2 (Klausuren-Abschlusstraining)%' and SUBSTRING(k.nr,1,5) = 'WBAON') THEN 'VAVE000067' --Bilanzstuerrecht2Klausuren-Abschlusstraining-Online 
when (k.TITEL like '%Bilanzsteuerrecht 3 (Klausuren-Abschlusstraining)%' and SUBSTRING(k.nr,1,5) = 'WBAON') THEN 'VAVE000068' --Bilanzstuerrecht3Klausuren-Abschlusstraining-Online 
when (k.TITEL like '%Ertragsteuern 2 (Klausuren-Abschlusstraining)%' and SUBSTRING(k.nr,1,5) = 'WBAON') THEN 'VAVE000069' --Ertragsteuer2Klausuren-Abschlusstraining-Online 
when (k.TITEL like '%Ertragsteuern 3 (Klausuren-Abschlusstraining)%' and SUBSTRING(k.nr,1,5) = 'WBAON') THEN 'VAVE000070' --Ertragsteuer3Klausuren-Abschlusstraining-Online 
when (k.TITEL like '%Umsatzsteuer (Klausuren-Abschlusstraining)%' and SUBSTRING(k.nr,1,5) = 'WBAON') THEN 'VAVE000073' --UmsatzstuerKlausuren-Abschlusstraining-Online 
when (k.TITEL like '%Ertragsteuern 1 (Klausuren-Abschlusstraining)%' and SUBSTRING(k.nr,1,5) = 'WBAON') THEN 'VAVE000302' --Ertragsteuer1-Klausuren-Abschlusstraining-Online 
when (k.TITEL like '%Bewertungsrecht (Klausuren-Abschlusstraining)%' and SUBSTRING(k.nr,1,5) = 'WBAON') THEN 'VAVE000490' --Bewertungsrecht-Abschlusstraining-Online 
...
'NIX'
END
) = 'VAVE000067' and k.BEGINN_DAT >= '01.01.2015'  and k.KURZBEZ not like '%Ausfall%' and (k.FACHB not in ('OR', 'VE','X'))   
