...
when ((substring(k.nr,2,5) = 'A8FLG') AND (substring(k.nr,7,2)) <> '-I' AND (k.AUSSENST in ('Bundesweit'))) THEN 'VAVE0000025' --Debitoren- Kreditoren GK FL
...
-- NEU AB 31.07.2022 neune Vorlagen hinzugefügt - TK
...
-- when (k.NR like '%B8%') THEN 'VAVE000702' hat schon ein Vorlagennummer: VAVE000064
when ( (SUBSTRING(k.nr,2,2 ) = 'PD' AND SUBSTRING(k.nr,6,2 ) = '33') and k.DAUER <> '') THEN 'VAVE000493' --  Vorlagennummer schon vergeben
when (k.NR like '_A2___5%') THEN 'VAVE000494' -- passt
when (k.NR like '_B3___H') THEN 'VAVE000495'  -- Vorlagennummer schon vergeben
when (k.NR  like '_INFOB01%') THEN 'VAVE000496' -- passt
when (k.NR  like '_INFOB02%') THEN 'VAVE000497' -- passt 
when (k.NR  like '_G6ON_') THEN 'VAVE000090'  -- Vorlagennummer schon vergeben
when (k.NR  like '_INFOB03%') THEN 'VAVE000157' -- Vorlagennummer schon vergeben
when (k.NR  like '_H2ON%') THEN 'VAVE000032' -- Vorlagennummer schon vergeben
when (k.NR like '_H3ON%') THEN 'VAVE000141' -- Vorlagennummer schon vergeben
when (k.NR like '_INFOB04%') THEN 'VAVE000161' -- Vorlagennummer schon vergeben
when (k.NR  like '_INFOB05%') THEN 'VAVE000164' -- Vorlagennummer schon vergeben
when (k.NR  like '_INFOB06%') THEN 'VAVE000169' -- Vorlagennummer schon vergeben
when (k.NR  like '_PWONJ5%') THEN 'VAVE000554' -- Vorlagennummer schon vergeben
when (k.NR  like '_PWONJ1%') THEN 'VAVE000701' -- passt
when (k.NR  like '_INFOB15%') THEN 'VAVE000700' --passt
when (k.NR  like '_INFOB16%') THEN 'VAVE000498'  -- Vorlagennummer schon vergeben, findet aber die richigen Kurse
when (k.NR  like '%INFOB1%') THEN 'VAVE000179' -- Vorlagennummer schon vergeben, findet aber die richigen Kurse; Kennzeichen INFOB1 nicht INFOB7
-- when (k.NR like '%INFOB_8%') THEN 'VAVE000182' hat schone eine Vorlagenummer: VAVA000017
when (k.NR  like '%INFOB_9%') THEN 'VAVE000187' -- Vorlagennummer schon vergeben; kennzeiche INFOB_9, nicht INFOB9
when (k.NR  like '%INFOB10%') THEN 'VAVE000218' --Vorlagennummer schon vergeben 
when (k.NR  like '_INFOB11%') THEN 'VAVE000226' --Vorlagennummer schon vergeben 
when (k.NR  like '_INFOB12%') THEN 'VAVE000229' --Vorlagennummer schon vergeben 
when (k.NR  like '_PWONJ7%') THEN 'VAVE000520' --Vorlagennummer schon vergeben 
when (k.NR  like '_PWONJ6%') THEN 'VAVE000519' --Vorlagennummer schon vergeben 
when (k.NR like '_PWONJ8%') THEN 'VAVE000499' --Vorlagennummer schon vergeben
when (k.NR like '_PWONJ9%') THEN 'VAVE000280' --Vorlagennummer schon vergeben
when (k.NR  like '_PWONK1%') THEN 'VAVE000279' --Vorlagennummer schon vergeben
when (k.NR  like '_PWONK2%') THEN 'VAVE000278' --Vorlagennummer schon vergeben
when (k.NR  like '_INFOE01%') THEN 'VAVE000518' --Vorlagennummer schon vergeben
when (k.NR  like '_INFOB13%') THEN 'VAVE000232' --Vorlagennummer schon vergeben
when (k.NR  like '_INFOB14%') THEN 'VAVE000252' --Vorlagennummer schon vergeben
