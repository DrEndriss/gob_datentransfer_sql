...
('nr', 'suchbegriff', 'name', 'vorname', 'typ', 'zusatz', 'ZUSATZ2', 'ort', 'strasse', 'TEL_ANZEIGE', 'TEL2_ANZEIGE', 'FAX_ANZEIGE', 'EMAIL_ANZEIGE', 'mandant', 'NOWERBUNG', 
...
'notelwerb_bearb', 'notelwerb_datum', 'notelwerb_via', 'notelwerb_bem', 'geschlecht', 'titel', 'gebdat', 'gebjahr', 'BANKBEZ', 'konto', 'blz', 'erm_grund', 'erm_ende', 
'erm_proz', 'guthaben', 'kontoname', 'KZ_TEXT', 'ANSPRACHE', 'BEARBEITER', 'NATION', 'BUNDESLAND', 'BEARBDATUM', 'RCHG_ADR_1', 'RCHG_ADR_2', 
'RCHG_ADR_3', 'RCHG_ADR_4', 'RCHG_ADR_5', 'RCHG_ADR_6', 'RCHG_ADR_7', 'ARBAMTNR', 'LAST_ERTEILT', 'REGISTRIERUNG', 
'NAME_VORNAME', 'Anrede', 'MITGEINTR', 'MITGBETR', 'MOBIL_ANZEIGE', 'FAX2_ANZEIGE', 'ArbAmtOrt', 'info', 'INFO_INTERN', 'eLearningPersonAktiv', 'eLearningLogin', 'BIC', 'IBAN', 'Verstorben', 'progh_dat', 'ErstelltDatum', 'ErstelltVon', 'Krit1', 'Krit2', 
...
'Newsl_AnlDatum', 'Newsl_Bemerk', 'InfoIntAnm', 'InfoAllgAnm', 'abteilung', 'entsendvhs', 'extern', 'adrfahrgemeinschaft', 'gekauftam', 'anm_sperre', 'nofaxwerb', 
