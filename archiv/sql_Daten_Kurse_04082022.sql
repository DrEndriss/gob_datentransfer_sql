...
when (k.KURZBEZ like 'Master of Arts in Taxation - Infoveranstaltung%on%') THEN 'VAVE000029' ---Intensivlehrgang - Finanzbuchhalter/-in/Online
...
when ((substring(k.nr,2,2) = 'B3') AND (k.AUSSENST in ('Online', 'Online-Kurs')) AND k.KURZBEZ not like '%Hybrid%') THEN 'VAVE000038' ---Steuerberater Samstagslehrgang/Online
...
when ((substring(k.nr,2,2) = 'B8' AND k.AUSSENST NOT LIKE 'Online%')) THEN 'VAVE000064' ---Steuerberater - Kombi-Lehrgang/Präsenz
...
when ((substring(k.nr,2,4) = 'C5ON') and (substring(k.nr,7,1) not in(1,2,3))) THEN 'VAVE000084' ---Steuerfachwirt - Klausurenlehrgang/Online HK
when ((substring(k.nr,2,4) = 'C5ON') and (substring(k.nr,7,1) in(1))) THEN 'VAVE000085' ---Steuerfachwirt - Klausurenlehrgang/Online GK1
when ((substring(k.nr,2,4) = 'C5ON') and (substring(k.nr,7,1) in(2))) THEN 'VAVE000086' ---Steuerfachwirt - Klausurenlehrgang/Online GK2
when ((substring(k.nr,2,4) = 'C5ON') and (substring(k.nr,7,1) in(3))) THEN 'VAVE000087' ---Steuerfachwirt - Klausurenlehrgang/Online GK3
...
when ((substring(k.nr,2,2) = 'D3') AND (k.AUSSENST not in ('Online', 'Online-Kurs','Video')) and (substring(k.nr,7,1) not in(1,2,3,4,5,6))) THEN 'VAVE000091' ---Controller-Samstaglehrgang/ HK Präsenz
when ((substring(k.nr,2,2) = 'D3') and (substring(k.nr,7,1) not in(1,2,3,4,5,6)) AND (k.AUSSENST in ('Online', 'Online-Kurs'))) THEN 'VAVE000092' ---Controller-Samstaglehrgang/Online HK
when ((substring(k.nr,2,2) = 'D3') and (substring(k.nr,7,1) in(1)) AND (k.AUSSENST not in ('Online', 'Online-Kurs','Video'))) THEN 'VAVE000093' ---Controller-Samstaglehrgang/Präsenz GK1
when ((substring(k.nr,2,2) = 'D3') and (substring(k.nr,7,1) in(2)) AND (k.AUSSENST not in ('Online', 'Online-Kurs','Video'))) THEN 'VAVE000095' ---Controller-Samstaglehrgang/Präsenz GK2
when ((substring(k.nr,2,2) = 'D3') and (substring(k.nr,7,1) in(3)) AND (k.AUSSENST not in ('Online', 'Online-Kurs','Video'))) THEN 'VAVE000097' ---Controller-Samstaglehrgang/Präsenz GK3
when ((substring(k.nr,2,2) = 'D3') and (substring(k.nr,7,1) in(4)) AND (k.AUSSENST not in ('Online', 'Online-Kurs','Video'))) THEN 'VAVE000099' ---Controller-Samstaglehrgang/Präsenz GK4
when ((substring(k.nr,2,2) = 'D3') and (substring(k.nr,7,1) in(5)) AND (k.AUSSENST not in ('Online', 'Online-Kurs','Video'))) THEN 'VAVE000101' ---Controller-Samstaglehrgang/Präsenz GK5
when ((substring(k.nr,2,2) = 'D3') and (substring(k.nr,7,1) in(1)) AND (k.AUSSENST in ('Online', 'Online-Kurs'))) THEN 'VAVE000094' ---Controller-Samstaglehrgang/Online GK1
when ((substring(k.nr,2,2) = 'D3') and (substring(k.nr,7,1) in(2)) AND (k.AUSSENST in ('Online', 'Online-Kurs'))) THEN 'VAVE000096' ---Controller-Samstaglehrgang/Online GK2
when ((substring(k.nr,2,2) = 'D3') and (substring(k.nr,7,1) in(3)) AND (k.AUSSENST in ('Online', 'Online-Kurs'))) THEN 'VAVE000098' ---Controller-Samstaglehrgang/Online GK3
when ((substring(k.nr,2,2) = 'D3') and (substring(k.nr,7,1) in(4)) AND (k.AUSSENST in ('Online', 'Online-Kurs'))) THEN 'VAVE000100' ---Controller-Samstaglehrgang/Online GK4
when ((substring(k.nr,2,2) = 'D3') and (substring(k.nr,7,1) in(5)) AND (k.AUSSENST in ('Online', 'Online-Kurs'))) THEN 'VAVE000530' ---Controller-Samstaglehrgang/Online GK5
when ((substring(k.nr,2,2) = 'D3') and (substring(k.nr,7,1) in(6)) AND (k.AUSSENST in ('Online', 'Online-Kurs'))) THEN 'VAVE000531' ---Controller-Samstaglehrgang/Online GK6

when ((substring(k.nr,2,2) = 'D4') and (substring(k.nr,9,1) in(1))) THEN 'VAVE000102' ---Controller-Prüfung I: Kostenrechnung und -Management
when ((substring(k.nr,2,2) = 'D4') and (substring(k.nr,9,1) in(2))) THEN 'VAVE000103' ---Controller-Prüfung II - 
when ((substring(k.nr,2,2) = 'D4') and (substring(k.nr,9,1) in(3))) THEN 'VAVE000104' ---Controller-Prüfung III - 
when ((substring(k.nr,2,2) = 'D4') and (substring(k.nr,9,1) in(4))) THEN 'VAVE000105' ---Controller-Prüfung IV - Online GK3


when ((substring(k.nr,2,2) = 'D5') AND (k.AUSSENST not in ('Online', 'Online-Kurs','Webinar')) and (substring(k.nr,7,1) not in(1,2,3,4,5))) THEN 'VAVE000112' ---Excel-Woche / HK Präsenz
when ((substring(k.nr,2,2) = 'D5') and (substring(k.nr,7,1) not in(1,2,3,4,5)) AND (k.AUSSENST in ('Online', 'Online-Kurs','Webinar'))) THEN 'VAVE000106' ---Excel-Woche - HK Webinar
when ((substring(k.nr,2,2) = 'D5') and (substring(k.nr,7,1) in(1)) AND (k.AUSSENST not in ('Online', 'Online-Kurs','Webinar'))) THEN 'VAVE000113' ---Excel-Woche Präsenz GK1
when ((substring(k.nr,2,2) = 'D5') and (substring(k.nr,7,1) in(2)) AND (k.AUSSENST not in ('Online', 'Online-Kurs','Webinar'))) THEN 'VAVE000114' ---Excel-Woche /Präsenz GK2
when ((substring(k.nr,2,2) = 'D5') and (substring(k.nr,7,1) in(3)) AND (k.AUSSENST not in ('Online', 'Online-Kurs','Webinar'))) THEN 'VAVE000115' ---Excel-Woche /Präsenz GK3
when ((substring(k.nr,2,2) = 'D5') and (substring(k.nr,7,1) in(4)) AND (k.AUSSENST not in ('Online', 'Online-Kurs','Webinar'))) THEN 'VAVE000116' ---Excel-Woche /Präsenz GK4
when ((substring(k.nr,2,2) = 'D5') and (substring(k.nr,7,1) in(5)) AND (k.AUSSENST not in ('Online', 'Online-Kurs','Webinar'))) THEN 'VAVE000117' ---Excel-Woche /Präsenz GK5
when ((substring(k.nr,2,2) = 'D5') and (substring(k.nr,7,1) in(1)) AND (k.AUSSENST in ('Online', 'Online-Kurs','Webinar'))) THEN 'VAVE000107' ---Excel-Woche /Online GK1
when ((substring(k.nr,2,2) = 'D5') and (substring(k.nr,7,1) in(2)) AND (k.AUSSENST in ('Online', 'Online-Kurs','Webinar'))) THEN 'VAVE000108' ---Excel-Woche /Online GK2
when ((substring(k.nr,2,2) = 'D5') and (substring(k.nr,7,1) in(3)) AND (k.AUSSENST in ('Online', 'Online-Kurs','Webinar'))) THEN 'VAVE000109' ---Excel-Woche /Online GK3
when ((substring(k.nr,2,2) = 'D5') and (substring(k.nr,7,1) in(4)) AND (k.AUSSENST in ('Online', 'Online-Kurs','Webinar'))) THEN 'VAVE000110' ---Excel-Woche /Online GK4
when ((substring(k.nr,2,2) = 'D5') and (substring(k.nr,7,1) in(5)) AND (k.AUSSENST in ('Online', 'Online-Kurs','Webinar'))) THEN 'VAVE000111' ---Excel-Woche /Online GK5

when ((substring(k.nr,2,2) = 'D8') AND (k.AUSSENST not in ('Online', 'Online-Kurs','Webinar')) and (substring(k.nr,7,1) not in(1,2,3,4))) THEN 'VAVE000118' ---Controller-Blocklehrgang: / HK Präsenz
when ((substring(k.nr,2,2) = 'D8') and (substring(k.nr,7,1) not in(1,2,3,4,5)) AND (k.AUSSENST in ('Online', 'Online-Kurs','Webinar'))) THEN 'VAVE000119' ---Controller-Blocklehrgang:  - HK Webinar
when ((substring(k.nr,2,2) = 'D8') and (substring(k.nr,7,1) in(1)) AND (k.AUSSENST not in ('Online', 'Online-Kurs','Webinar'))) THEN 'VAVE000120' ---Controller-Blocklehrgang: Modul GK1
when ((substring(k.nr,2,2) = 'D8') and (substring(k.nr,7,1) in(2)) AND (k.AUSSENST not in ('Online', 'Online-Kurs','Webinar'))) THEN 'VAVE000122' ---Controller-Blocklehrgang: Modul /Präsenz GK2
when ((substring(k.nr,2,2) = 'D8') and (substring(k.nr,7,1) in(3)) AND (k.AUSSENST not in ('Online', 'Online-Kurs','Webinar'))) THEN 'VAVE000124' ---Controller-Blocklehrgang: Modul /Präsenz GK3
when ((substring(k.nr,2,2) = 'D8') and (substring(k.nr,7,1) in(4)) AND (k.AUSSENST not in ('Online', 'Online-Kurs','Webinar'))) THEN 'VAVE000126' ---Controller-Blocklehrgang: Modul /Präsenz GK4
when ((substring(k.nr,2,2) = 'D8') and (substring(k.nr,7,1) in(1)) AND (k.AUSSENST in ('Online', 'Online-Kurs','Webinar'))) THEN 'VAVE000121' ---Controller-Blocklehrgang: Modul/Online GK1
when ((substring(k.nr,2,2) = 'D8') and (substring(k.nr,7,1) in(2)) AND (k.AUSSENST in ('Online', 'Online-Kurs','Webinar'))) THEN 'VAVE000123' ---Controller-Blocklehrgang: Modul /Online GK2
when ((substring(k.nr,2,2) = 'D8') and (substring(k.nr,7,1) in(3)) AND (k.AUSSENST in ('Online', 'Online-Kurs','Webinar'))) THEN 'VAVE000125' ---Controller-Blocklehrgang: Modul /Online GK3
when ((substring(k.nr,2,2) = 'D8') and (substring(k.nr,7,1) in(4)) AND (k.AUSSENST in ('Online', 'Online-Kurs','Webinar'))) THEN 'VAVE000127' ---Controller-Blocklehrgang: Modul/Online GK4

when ((substring(k.nr,2,2) = 'D9') and (substring(k.nr,6,1) not in(1,2,3,4,5))) THEN 'VAVE000128' ---Controller-Fernlehrgang
when ((substring(k.nr,2,2) = 'D9') and (substring(k.nr,6,1) in(1)) and (substring(k.nr,7,2) not in('-I'))) THEN 'VAVE000129' ---Controller-Fernlehrgang Modul1
when ((substring(k.nr,2,2) = 'D9') and (substring(k.nr,6,1) in(2)) and (substring(k.nr,7,2) not in('-I'))) THEN 'VAVE000130' ---Controller-Fernlehrgang Modul2
when ((substring(k.nr,2,2) = 'D9') and (substring(k.nr,6,1) in(3)) and (substring(k.nr,7,2) not in('-I'))) THEN 'VAVE000131' ---Controller-Fernlehrgang Modul3
when ((substring(k.nr,2,2) = 'D9') and (substring(k.nr,6,1) in(4)) and (substring(k.nr,7,2) not in('-I'))) THEN 'VAVE000132' ---Controller-Fernlehrgang Modul4
when ((substring(k.nr,2,2) = 'D9') and (substring(k.nr,6,1) in(5)) and (substring(k.nr,7,2) not in('-I'))) THEN 'VAVE000133' ---Controller-Fernlehrgang Modul5
...
when ((substring(k.nr,2,2) = 'E3') and (substring(k.nr,7,1) not in('I')) AND (k.AUSSENST not in ('Online-Kurs'))) THEN 'VAVE000139' ---Bilanzbuchhalter-Samstagslehrgang-Präsens
...
when ((substring(k.nr,2,2) = 'F9') and (substring(k.nr,6,2) not in('-I'))) THEN 'VAVE000156' ---Wirtschaftsfachwirt-Fernlehrganglehrgang
...
when ((substring(k.nr,2,4) = 'H5FL') and (substring(k.nr,7,2) not in('-I'))) THEN 'VAVE000159' ---Fernlehrganglehrgang-InternationalAccounting
when ((substring(k.nr,2,4) = 'H5PR')) THEN 'VAVE000160' ---Fernlehrganglehrgang-InternationalAccounting-Prüfung

when ((substring(k.nr,2,2) = 'H9')and (substring(k.nr,6,2) not in('-I'))) THEN 'VAVE000162' ---Bilanzbuchhalter-International-Fernlehrang
...
when ((substring(k.nr,2,5) = 'INFOB') AND (k.AUSSENST not in ('Online-Infoveranstaltung', 'Video', 'Online')) AND k.KURZBEZ NOT LIKE '%Vorstellung%' and k.KURZBEZ NOT LIKE '%Endriss%' AND k.KURZBEZ NOT LIKE '%Klausur%' ) THEN 'VAVE000184' ---Steuerberater-Infoveranstaltung-Präsens
...
when ((substring(k.nr,2,5) = 'INFOE') AND (k.AUSSENST not in ('Online-Infoveranstaltung', 'Video', 'Online')) AND k.KURZBEZ NOT LIKE '%Mündlich%') THEN 'VAVE000167' ---Bilanzbuchhalter-Infoveranstaltung-Präsens
...
when ((substring(k.nr,2,2) = 'U5' ) and (k.nr like '%B%') AND (k.aussenst not in ('Webinar','Online'))) THEN 'VAVE000547' ----Fachseminar-für-Fachberater-für-Internationales-Steuerrecht-Tag2
when ((substring(k.nr,2,2) = 'U5' ) and (k.nr like '%A%') AND (k.aussenst not in ('Webinar','Online'))) THEN 'VAVE000547' ----Fachseminar-für-Fachberater-für-Internationales-Steuerrecht-Tag2
...
when ((substring(k.nr,2,2) = 'PD' ) and(substring(k.nr,6,2) = '22') and(substring(k.nr,4,2) <> 'BU') AND (k.aussenst not in ('Webinar','Online','Online-Kurs','online'))) THEN 'VAVE000251' ----Prä
...
when ((k.kurzbez like '%Pensions%') and (k.nr not like '%INHAIR%') AND k.KURZBEZ NOT LIKE '%Endriss%') THEN 'VAVA000017' ---Inhouse
...
when ((k.nr not like '%INH%') and (k.kurzbez like '%Rückstell%') and (k.nr not like '%ON%') AND (k.aussenst in ('Webinar','Online') and k.KURZBEZ NOT LIKE '%Endriss%')) THEN 'VAVA000080' 
...
when (k.KURZBEZ like 'FB - Prüfung' AND k.AUSSENST NOT IN ('Online','Online-Kurs')) THEN 'VAVE000696'
...
when (SUBSTRING(k.NR,2,2) = 'PW' AND SUBSTRING(k.NR,6,2) = 'G6') THEN 'VAVE000729'
...
when (k.KURZBEZ like 'Bilanzbuchhaltung-International%' AND k.KURZBEZ NOT like '%Online%') THEN 'VAVE000494'
when (k.KURZBEZ like 'Mehr- und Minderabführungen in der Organschaft') THEN 'VAVE000495'
when (k.KURZBEZ like '%Bilanzbuchhalter International%' AND k.AUSSENST in ('Online-Kurs') AND k.KURZBEZ NOT like '%Online%') THEN 'VAVE000494'
...
when (k.KURZBEZ like 'Prüfung - Finanzbuchhalter/-in' AND k.AUSSENST NOT IN ('Online','Online-Kurs')) THEN 'VAVE000696'
...
when (k.NR  like '%A_ON_P' AND k.KURZBEZ like '%Fin%') THEN 'VAVE000006'
...
when (k.TITEL like '%Prüfung Lohn und Gehaltsbuchhalter%' AND k.AUSSENST like '%On%') THEN 'VAVE000017'
when (k.KURZBEZ like 'Prüfung - Anlagenbuchhalter/in' AND k.ORT like '%On%') THEN 'VAVE000020'
when (k.NR  like '_A1%P' AND k.AUSSTELL NOT IN ('Online','Online-Kurs')) THEN 'VAVE000032'
when (k.NR  like '_BA%' AND k.NR NOT LIKE '_BAON%') THEN 'VAVE000071'
when (k.NR  like '_BAON%' AND k.AUSSENST NOT IN ('Abgabenordnung')) THEN 'VAVE000072'
...
when (k.TITEL like 'EndrissUPdate für Steuerberater (Abonnement: 4 Termine/Jahr)') THEN 'VAVE000432'
...
when(SUBSTRING(k.NR,2,4) = 'BAON') THEN 'VAVE000065'

when(k.KURZBEZ like '%Neu in der Personalabteilung im öffentlichen Dienst%') THEN 'VAVE000496'

when (k.NR like '%B8%') THEN 'VAVE000702' 
when ( (SUBSTRING(k.nr,2,2 ) = 'PD' AND SUBSTRING(k.nr,6,2 ) = '33') and k.DAUER <> '') THEN 'VAVE000703' 
when (k.NR like '_A2___5%') THEN 'VAVE000494' 
when (k.NR like '_B3___H') THEN 'VAVE000704'  
when (k.NR  like '_INFOB01%') THEN 'VAVE000708' 
when (k.NR  like '_INFOB02%') THEN 'VAVE000706' 
when (k.NR  like '_G6ON_') THEN 'VAVE000709'  
when (k.NR  like '_INFOB03%') THEN 'VAVE000710' 
when (k.NR  like '_H2ON%') THEN 'VAVE000497' 
when (k.NR like '_H3ON%') THEN 'VAVE000711' 
when (k.NR like '_INFOB04%') THEN 'VAVE000712' 
when (k.NR  like '_INFOB05%') THEN 'VAVE000705' 
when (k.NR  like '_INFOB06%') THEN 'VAVE000713' 
when (k.NR  like '_PWONJ5%') THEN 'VAVE000714' 
when (k.NR  like '_PWONJ1%') THEN 'VAVE000701' 
when (k.NR  like '_INFOB15%') THEN 'VAVE000700'


-- NEU AB 04.08.2022 Neue Vorlagen vergeben  TK, SD, TE
when (k.NR  like '_INFOB16%') THEN 'VAVE000715' 
when (k.NR  like '%INFOB07%') THEN 'VAVE000716' 
when (k.NR like '%INFOB08%') THEN 'VAVE000717'
when (k.NR  like '%INFOB_9%') THEN 'VAVE000718' 
when (k.NR  like '%INFOB10%') THEN 'VAVE000719'
when (k.NR  like '_INFOB11%') THEN 'VAVE000720' 
when (k.NR  like '_INFOB12%') THEN 'VAVE000721'
when (k.NR  like '_PWONJ7%') THEN 'VAVE000722'
when (k.NR  like '_PWONJ6%') THEN 'VAVE000723'
when (k.NR like '_PWONJ8%') THEN 'VAVE000724'
when (k.NR like '_PWONJ9%') THEN 'VAVE000725' 
when (k.NR  like '_PWONK1%') THEN 'VAVE000726' 
when (k.NR  like '_PWONK2%') THEN 'VAVE000727'
when (k.NR  like '_INFOE01%') THEN 'VAVE000728' 
when (k.NR  like '_INFOB13%') THEN 'VAVE000232' 
when (k.NR  like '_INFOB14%') THEN 'VAVE000730' 
when (k.NR  like '_F3LS%') THEN 'VAVE000707'
when (k.NR  like '_PB__12%') THEN 'VAVE000731' 
when (k.NR  like '_PD__17%'  AND k.AUSSENST LIKE '%Web%') THEN 'VAVE000732' 
-- when (k.NR  like '_PD__17%'  AND k.AUSSENST NOT LIKE '%Web%') THEN 'VAVE000732' braucht eine neue Vorlagenummer, Präsen
when (k.NR  like '_PD__18%' AND k.AUSSENST LIKE '%Web%') THEN 'VAVE000733'
-- when (k.NR  like '_PD__18%' AND k.AUSSENST NOT LIKE '%Web%') THEN 'VAVE000733' braucht eine neue Vorlagenummer, Präsens
when (k.NR like '_PWONI6%') THEN 'VAVE000734' 
when (k.NR  like '_PWONI7%') THEN 'VAVE000735'
when (k.NR  like '_PWONI8%') THEN 'VAVE000736' 
when (k.NR  like '_PWONI9%') THEN 'VAVE000737' 
when (k.NR  like '_PWONJ2%') THEN 'VAVE000738' 
when (k.NR  like '_PWONJ3%') THEN 'VAVE000739' 
when (k.NR  like '_PWONJ4%') THEN 'VAVE000740' 
...
END as VLG
,isnull
-- NEU AB 15.07.2022 BC Nummer angepasst und neue Orte hinzugefügt
(case 
	when upper(k.ORT) like '%HÖRSAAL I' and upper(k.ORT) like '%DÜSSELDORF%'  then '100146'
	when upper(k.ORT) like '%HÖRSAAL II' and upper(k.ORT) like '%DÜSSELDORF%' then '100149'
	when upper(k.ORT) like '%HÖRSAAL I' and upper(k.ORT) like '%FRANKFURT%' and upper(KURSORTE.STRASSE) like '%Hanauer%'then '100272'
	when upper(k.ORT) like '%HÖRSAAL I' and upper(k.ORT) like '%FRANKFURT%' and upper(KURSORTE.STRASSE) like '%Darmst%'then '100318'
	when upper(k.ORT) like '%HÖRSAAL II' and upper(k.ORT) like '%FRANKFURT%' and upper(KURSORTE.STRASSE) like '%Hanauer%' then '100271'
	when upper(k.ORT) like '%HÖRSAAL II' and upper(k.ORT) like '%FRANKFURT%' and upper(KURSORTE.STRASSE) like '%Darmst%' then '100316'
	when upper(k.ORT) like '%HÖRSAAL III' and upper(k.ORT) like '%FRANKFURT%' then '100270'
	when upper(k.ORT) like '%HÖRSAAL IV' and upper(k.ORT) like '%FRANKFURT%' then '100273'
	when upper(k.ORT) like '%HÖRSAAL I' and upper(k.ORT) like '%HANNOVER%' then '100114'
	when upper(k.ORT) like '%HÖRSAAL II' and upper(k.ORT) like '%HANNOVER%' then '100113'
	when upper(k.ORT) like '%HÖRSAAL I' and upper(k.ORT) like '%HAMBURG%' then '100071'
	when upper(k.ORT) like '%HÖRSAAL II' and upper(k.ORT) like '%HAMBURG%' then '100068'
	when upper(k.ORT) like '%HÖRSAAL III' and upper(k.ORT) like '%HAMBURG%' then '100069'
	when upper(k.ORT) like '%Hamburg, Steuer-Fachschule Hörsaal 3+4%' and upper(k.ORT) like '%HAMBURG%' then '100074'
	when upper(k.ORT) like '%HÖRSAAL IV' and upper(k.ORT) like '%HAMBURG%' then '100076'
	when upper(k.ORT) like '%HÖRSAAL I' and upper(k.ORT) like '%KÖLN%' then '100001'
	when upper(k.ORT) like '%HÖRSAAL II' and upper(k.ORT) like '%KÖLN%' then '100002'
	when upper(k.ORT) like '%HÖRSAAL III' and upper(k.ORT) like '%KÖLN%' then '100003'
	when upper(k.ORT) like '%HÖRSAAL IV' and upper(k.ORT) like '%KÖLN%' then '100004'
	when upper(k.ORT) like '%HÖRSAAL I' and upper(k.ORT) like '%MANNHEIM%' then '100337'
	when upper(k.ORT) like '%HÖRSAAL II' and upper(k.ORT) like '%MANNHEIM%' then '100338'
	when upper(k.ORT) like '%HÖRSAAL III' and upper(k.ORT) like '%MANNHEIM%' then '100340'
	when upper(k.ORT) like '%HÖRSAAL I' and upper(k.ORT) like '%MÜNCHEN%' then '100407'
	when upper(k.ORT) like '%HÖRSAAL II' and upper(k.ORT) like '%MÜNCHEN%' then '100406'
	when upper(k.ORT) like '%HÖRSAAL III' and upper(k.ORT) like '%MÜNCHEN%' then '100402'
	when upper(k.ORT) like '%HÖRSAAL I' and upper(k.ORT) like '%STUTTGART%' and upper(KURSORTE.STRASSE) like '%Kronen%' then '100349'
	when upper(k.ORT) like '%HÖRSAAL II' and upper(k.ORT) like '%STUTTGART%' and upper(KURSORTE.STRASSE) like '%Kronen%' then '100351'
	when upper(k.ORT) like '%HÖRSAAL I' and upper(k.ORT) like '%STUTTGART%' and upper(KURSORTE.STRASSE) like '%Heilbro%' then '100353'
	when upper(k.ORT) like '%HÖRSAAL II' and upper(k.ORT) like '%STUTTGART%' and upper(KURSORTE.STRASSE) like '%Heilbro%'then '100358'
...
--  NEU AB 15.07.2022 Join Kursort Tablle um auf Strasse zuzugreifen, damit die BCNummern eindeutig hinzúgefügt werden können
...
-- NEU AB 15.07.2022 Group by entfernt, Das Feld: k.INFO kann nicht in einem GROUP BY verwendet werde
--group by k.INFO,Hauptkurs, k.NR,TYP, BEGINN_DAT, ENDE_DAT,k.mandant,k.ORT,FACHB,DAUER,DOZSTDREAL,AUSSENST,SEMESTER,AUSFALL,SONDERGEB,FACHB_BVV,FACHB_LAND,KURZBEZ,DAUERDETAI,BEGINN,ENDE,GEB_ORG,GEBUEHR,GEB_ART,TEIL_MAX,TEIL_MIN,TEIL_AKT,TEIL_WART,WARNUNG,KURS_ART,KART_KEY,ANRECHEN,STUNDENANZ,VERTRTAGE,kg.Bearbeiter,k.BEARBEITER,VERLAUF,BIS_MAX,ABG_DATUM,KNR_ORG,k.BEARBDATUM,ABW_ANRECHEN,NSAMASSNAHME,KURSAUSWAHL1,KURSAUSWAHL4,KURSAUSWAHL7,VERWALTUNG,HPM,MINUTENTAG,PAUSETAG,UETAG,TITEL,MATERIAL,INTNOTIZ,VERTRAG,ZEUGNIS,ABG_BEMERK,WOTAG,Sofortzahl,eLearningKursAktiv,eLearningVon,eLearningBis,KSK,NeuerKurs,Essen_JN,InternetAktiv,k.ErstelltDatum,EMailStatus,Fa_Pauschal,WebFlags,WFWeitergabe,eLearningKursID,k.ErstelltVon,Master_knr,teil_soll,info_gesperrt,beleg_ans,zgvorlbeschreibung,zgvorldateiname,nr_anzeige,KURSAUSWAHL8,KURSAUSWAHL9,k.AUSSTELL
ORDER BY 2