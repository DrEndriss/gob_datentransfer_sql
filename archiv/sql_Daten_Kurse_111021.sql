...
when k.mandant in ('1') and Substring(k.NR,2,1) = 'N' then '70030'
...
when ((substring(k.nr,2,2) = 'A1') AND (substring(k.nr,7,2)) = '3G') AND (k.AUSSENST not in ('Online', 'Online-Kurs')) THEN 'VAVE000493'
when ((substring(k.nr,2,2) = 'A1') AND (substring(k.nr,7,2)) = '3G') AND (k.AUSSENST in ('Online', 'Online-Kurs')) THEN 'VAVE000495'
when ((substring(k.nr,2,2) = 'A1') AND (substring(k.nr,8,1)) = 'P') AND (k.AUSSENST in ('Online', 'Online-Kurs')) THEN 'VAVE000002' ---Dbk Online Prüfung
when ((substring(k.nr,2,2) = 'A1') AND (substring(k.nr,7,1)) = 'P') AND (k.AUSSENST in ('Online', 'Online-Kurs')) THEN 'VAVE000002' ---Dbk Online Prüfung
...
when ((substring(k.nr,2,2) = 'A1') AND (substring(k.nr,7,2)) = '1G') AND (k.AUSSENST not in ('Online', 'Online-Kurs')) THEN 'VAVE000497'
when ((substring(k.nr,2,2) = 'A1') AND (substring(k.nr,7,2)) = '1G') AND (k.AUSSENST in ('Online', 'Online-Kurs')) THEN 'VAVE000496'
when ((substring(k.nr,2,2) = 'A1') AND (substring(k.nr,7,2)) = '2D') AND (k.AUSSENST not in ('Online', 'Online-Kurs')) THEN 'VAVE000003'
when ((substring(k.nr,2,2) = 'A1') AND (substring(k.nr,7,2)) = '2G') AND (k.AUSSENST not in ('Online', 'Online-Kurs')) THEN 'VAVE000498'
...
when ((substring(k.nr,2,2) = 'A2') AND (substring(k.nr,7,2)) = '3F') AND (k.AUSSENST in ('Video')) THEN 'VAVE000011'
when ((substring(k.nr,2,2) = 'A2') AND (substring(k.nr,7,2)) = '3G') AND (k.AUSSENST not in ('Online', 'Online-Kurs','Video')) THEN 'VAVE000501'
when ((substring(k.nr,2,2) = 'A2') AND (substring(k.nr,7,2)) = '3G') AND (k.AUSSENST in ('Online', 'Online-Kurs')) THEN 'VAVE000499'
when ((substring(k.nr,2,2) = 'A2') AND (substring(k.nr,7,2)) = '3G') AND (k.AUSSENST in ('Video')) THEN 'VAVE000500'
when ((substring(k.nr,2,2) = 'A2') AND (substring(k.nr,7,1)) = 'P') AND (k.AUSSENST in ('Online', 'Online-Kurs')) THEN 'VAVE000006' --Finanzbuchhalter /Prüfung neu
when ((substring(k.nr,2,2) = 'A2') AND (substring(k.nr,8,1)) = 'P') AND (k.AUSSENST in ('Online', 'Online-Kurs')) THEN 'VAVE000006' --Finanzbuchhalter /Prüfung alt
...
when ((substring(k.nr,2,2) = 'A2') AND (substring(k.nr,7,2)) = '1F') AND (k.AUSSENST in ('Online', 'Online-Kurs')) THEN 'VAVE000013'
when ((substring(k.nr,2,2) = 'A2') AND (substring(k.nr,7,2)) = '1G') AND (k.AUSSENST not in ('Online', 'Online-Kurs')) THEN 'VAVE000502'--Finanzbuchhalter /Grundlage
when ((substring(k.nr,2,2) = 'A2') AND (substring(k.nr,7,2)) = '1G') AND (k.AUSSENST in ('Online', 'Online-Kurs')) THEN 'VAVE000503'
...
when ((substring(k.nr,2,2) = 'A2') AND (substring(k.nr,7,2)) = '2G') AND (k.AUSSENST not in ('Online', 'Online-Kurs')) THEN 'VAVE000504'
when ((substring(k.nr,2,2) = 'A2') AND (substring(k.nr,7,2)) = '2G') AND (k.AUSSENST in ('Online', 'Online-Kurs')) THEN 'VAVE000505'
...
when ((substring(k.nr,2,2) = 'A3') AND (substring(k.nr,7,2)) = '3G') AND (k.AUSSENST not in ('Online', 'Online-Kurs','Video')) THEN 'VAVE000507'
when ((substring(k.nr,2,2) = 'A3') AND (substring(k.nr,7,2)) = '3G') AND (k.AUSSENST in ('Online', 'Online-Kurs')) THEN 'VAVE000508'
when ((substring(k.nr,2,2) = 'A3') AND (substring(k.nr,7,2)) = '3G') AND (k.AUSSENST in ('Video')) THEN 'VAVE000494'
when ((substring(k.nr,2,2) = 'A3') AND (substring(k.nr,7,1)) = 'P') AND (k.AUSSENST in ('Online', 'Online-Kurs')) THEN 'VAVE000017' ----Lohn und Gehaltsbuchhalter/Prüfung neu
when ((substring(k.nr,2,2) = 'A3') AND (substring(k.nr,8,1)) = 'P') AND (k.AUSSENST not in ('Online', 'Online-Kurs')) THEN 'VAVE000017' ----Lohn und Gehaltsbuchhalter/Prüfung alt
...
when ((substring(k.nr,2,2) = 'A3') AND (substring(k.nr,7,2)) = '1G') AND (k.AUSSENST not in ('Online', 'Online-Kurs')) THEN 'VAVE000510'--Lohn und Gehaltsbuchhalter /Grundlage
when ((substring(k.nr,2,2) = 'A3') AND (substring(k.nr,7,2)) = '1G') AND (k.AUSSENST in ('Online', 'Online-Kurs')) THEN 'VAVE000511'
...
when ((substring(k.nr,2,2) = 'A3') AND (substring(k.nr,7,2)) = '2G') AND (k.AUSSENST not in ('Online', 'Online-Kurs')) THEN 'VAVE000513'
when ((substring(k.nr,2,2) = 'A3') AND (substring(k.nr,7,2)) = '2G') AND (k.AUSSENST in ('Online', 'Online-Kurs')) THEN 'VAVE000514'
...
when ((substring(k.nr,2,2) = 'A5') AND (substring(k.nr,7,2)) = '3G') AND (k.AUSSENST not in ('Online', 'Online-Kurs','Video')) THEN 'VAVE000516' --Anlagenbuchhalter /Grundlagen
when ((substring(k.nr,2,2) = 'A5') AND (substring(k.nr,8,1)) = 'P') AND (k.AUSSENST in ('Online', 'Online-Kurs')) THEN 'VAVE000020' ----Anlagenbuchhalter/Prüfung neu
when ((substring(k.nr,2,2) = 'A6') AND (substring(k.nr,7,1)) = 'P') AND (k.AUSSENST in ('Online', 'Online-Kurs')) THEN 'VAVE000020' ----Anlagenbuchhalter/Prüfung alt
...
when ((substring(k.nr,2,2) = 'A5') AND (substring(k.nr,7,2)) = '2G') AND (k.AUSSENST in ('Online', 'Online-Kurs')) THEN 'VAVE000517'--Anlagenbuchhalter /Abendlehrgang Online Grundkurs
...
when ((substring(k.nr,2,5) = 'A7FLG') AND (substring(k.nr,9,2)) <> '-I' AND (k.AUSSENST in ('Bundesweit'))) THEN 'VAVE000518' --Lohn- und Gehaltbuchhalter GK FL
...
when ((substring(k.nr,2,5) = 'A8FLG') AND (substring(k.nr,7,2)) <> '-I' AND (k.AUSSENST in ('Bundesweit'))) THEN 'VAVE000519' --Debitoren- Kreditoren GK FL
...
when ((substring(k.nr,2,5) = 'A9FLF') AND (substring(k.nr,8,2)) <> '-I' AND (k.AUSSENST in ('Bundesweit'))) THEN 'VAVE000026' --Finanzbuchhalter FL
when ((substring(k.nr,2,5) = 'A9FLG') AND (substring(k.nr,7,2)) <> '-I' AND (k.AUSSENST in ('Bundesweit'))) THEN 'VAVE000520' --Finanzbuchhalter GK FL
when ((substring(k.nr,2,2) = 'A9') AND (substring(k.nr,7,1)) = 'P')  AND (k.AUSSENST in ('Bundesweit')) THEN 'VAVE000006' ----Finanzbuchhalter GK FL Prüfung
when ((substring(k.nr,2,3) = 'A9P'))  THEN 'VAVE000006' ----Finanzbuchhalter GK FL Prüfung

when ((substring(k.nr,2,2) = 'AB') AND (k.AUSSENST not in ('Online', 'Online-Kurs','Video'))) THEN 'VAVE000028' ---Intensivlehrgang - Finanzbuchhalter/-in/Präsenz
...
when ((substring(k.nr,2,2) = 'C5') AND (k.AUSSENST not in ('Online', 'Online-Kurs','Video'))) THEN 'VAVE000083' ---Steuerfachwirt - Klausurenlehrgang/Präsenz
...
when ((substring(k.nr,1,5) = 'SE9FL')) THEN 'VAVE000282' ---Bilanzbuchhalter-Fernlehrgang
when ((substring(k.nr,1,5) = 'TE9FL')) THEN 'VAVE000282' ---Bilanzbuchhalter-Fernlehrgang
when ((substring(k.nr,1,5) = 'UE9FL')) THEN 'VAVE000282' ---Bilanzbuchhalter-Fernlehrgang
when ((substring(k.nr,1,5) = 'VE9FL')) THEN 'VAVE000282' ---Bilanzbuchhalter-Fernlehrgang
...
when ((substring(k.nr,2,2) = 'F2') AND (k.AUSSENST not in ('Online-Kurs'))) THEN 'VAVE000274' ---Wirtschaftsfachwirt-Abendlehrgang--Präsenz
when ((substring(k.nr,2,2) = 'F3') AND (k.AUSSENST in ('Online-Kurs'))) THEN 'VAVE000538' ---Wirtschaftsfachwirt-Samstaglehrgang--Online
...
when ((substring(k.nr,2,5) = 'INFOD') AND (k.AUSSENST in ('Video')) AND ( substring(k.kurzbez,1,2) = 'So')) THEN 'VAVE000179' ---Controller-Fernlehrgang-Infoveranstaltung-Video
...
when ((substring(k.nr,2,2) = 'XE') and (k.TITEL like '%Weiterbildung Bilanzbuchhalter/in Zusatzqu%')) THEN 'VAVE000478' ----Weiterbildung Bilanzbuchhalter-Zusatzqu
...
when ((substring(k.nr,2,2) = 'XH') and (k.TITEL like '%Weiterbildung Bilanzbuchhalter/in International (IHK)%')) THEN 'VAVE000481' ----Weiterbildung Bilanzbuchhalter-International (IHK)
...
when ((substring(k.nr,2,2) = 'PA' ) and(substring(k.nr,6,2) = '97') AND (k.aussenst in ('Webinar','Online','Online-Kurs','online'))) THEN 'VAVE000385' ----Zertifiziete-Endgeldabrechner-Online
...
when ((substring(k.nr,2,2) = 'PB' ) and(substring(k.nr,6,2) = '12') and(substring(k.nr,4,2) <> 'BU') AND (k.aussenst in ('Webinar','Online','Online-Kurs','online'))) THEN 'VAVE000569' ----Online
...
when ((substring(k.nr,2,2) = 'PD' ) and(substring(k.nr,6,2) = '17') and(substring(k.nr,4,2) <> 'BU') AND (k.aussenst in ('Webinar','Online','Online-Kurs','online'))) THEN 'VAVE000571' ----Online
when ((substring(k.nr,2,2) = 'PD' ) and(substring(k.nr,6,2) = '18') and(substring(k.nr,4,2) <> 'BU') AND (k.aussenst in ('Webinar','Online','Online-Kurs','online'))) THEN 'VAVE000572' ----Online
...
when ((substring(k.nr,2,2) = 'PD' ) and(substring(k.nr,6,2) = '30') and(substring(k.nr,4,2) <> 'BU') AND (k.aussenst in ('Webinar','Online','Online-Kurs','online'))) THEN 'VAVE000301' ----Online
...
when ((substring(k.nr,1,10) = 'VPWONABO4E')) THEN 'VAVE000692' ----Endriss-Mediathek
...
where k.BEGINN_DAT >= '01.01.2015' and k.KURZBEZ not like '%Ausfall%' and (k.FACHB not in ('OR', 'VE','X'))  order by 2