...
isnull
(case 
	when upper(kt.ORT) like '%HÖRSAAL I' and upper(kt.ORT) like '%DÜSSELDORF%' then '100151'
	when upper(kt.ORT) like '%HÖRSAAL II' and upper(kt.ORT) like '%DÜSSELDORF%' then '100151'
	when upper(kt.ORT) like '%HÖRSAAL I' and upper(kt.ORT) like '%FRANKFURT%' then '100277'
	when upper(kt.ORT) like '%HÖRSAAL II' and upper(kt.ORT) like '%FRANKFURT%' then '100277'
	when upper(kt.ORT) like '%HÖRSAAL III' and upper(kt.ORT) like '%FRANKFURT%' then '100277'
	when upper(kt.ORT) like '%HÖRSAAL IV' and upper(kt.ORT) like '%FRANKFURT%' then '100277'
	when upper(kt.ORT) like '%HÖRSAAL I' and upper(kt.ORT) like '%HANNOVER%' then '100112'
	when upper(kt.ORT) like '%HÖRSAAL II' and upper(kt.ORT) like '%HANNOVER%' then '100112'
	when upper(kt.ORT) like '%HÖRSAAL I' and upper(kt.ORT) like '%HAMBURG%' then '100070'
	when upper(kt.ORT) like '%HÖRSAAL II' and upper(kt.ORT) like '%HAMBURG%' then '100070'
	when upper(kt.ORT) like '%HÖRSAAL III' and upper(kt.ORT) like '%HAMBURG%' then '100070'
	when upper(kt.ORT) like '%HÖRSAAL IV' and upper(kt.ORT) like '%HAMBURG%' then '100070'
	...
	when upper(kt.ORT) like '%HÖRSAAL I' and upper(kt.ORT) like '%MANNHEIM%' then '100336'
	when upper(kt.ORT) like '%HÖRSAAL II' and upper(kt.ORT) like '%MANNHEIM%' then '100336'
	when upper(kt.ORT) like '%HÖRSAAL III' and upper(kt.ORT) like '%MANNHEIM%' then '100336'
	when upper(kt.ORT) like '%HÖRSAAL I' and upper(kt.ORT) like '%MÜNCHEN%' then '100403'
	when upper(kt.ORT) like '%HÖRSAAL II' and upper(kt.ORT) like '%MÜNCHEN%' then '100403'
	when upper(kt.ORT) like '%HÖRSAAL III' and upper(kt.ORT) like '%MÜNCHEN%' then '100403'
	when upper(kt.ORT) like '%HÖRSAAL I' and upper(kt.ORT) like '%STUTTGART%' then '100357'
	when upper(kt.ORT) like '%HÖRSAAL II' and upper(kt.ORT) like '%STUTTGART%' then '100357'
