...
iif(strasse is NULL, '', strasse) as strasse, 	   
...
iif(nopostwerb_datum is NULL, '30.12.1899', nopostwerb_datum) as nopostwerb_datum, 	   
...
iif(nomailwerb_datum is NULL, '30.12.1899', nomailwerb_datum) as nomailwerb_datum, 	   
...
iif(notelwerb_datum is NULL, '30.12.1899', notelwerb_datum) as notelwerb_datum, 	   
...
iif(gebdat is NULL, '30.12.1899', gebdat) as gebdat, 	   
...
iif(erm_ende is NULL, '', erm_ende) as erm_ende, 	   
...
iif(LAST_ERTEILT is NULL, '', LAST_ERTEILT) as LAST_ERTEILT, 	   
iif(REGISTRIERUNG is NULL, '', REGISTRIERUNG) as REGISTRIERUNG, 	   
iif(Anrede is NULL, '', Anrede) as Anrede, 	   
iif(MITGEINTR is NULL, '', MITGEINTR) as MITGEINTR, 	   
...
iif(progh_dat is NULL, '', progh_dat) as progh_dat, 	   
iif(ErstelltDatum is NULL, '30.12.1899', ErstelltDatum) as ErstelltDatum, 	   
...
iif(eLearningVon is NULL, '', eLearningVon) as eLearningVon, 	   
iif(eLearningBis is NULL, '', eLearningBis) as eLearningBis, 	   
...
iif(Newsl_AnlDatum is NULL, '30.12.1899', Newsl_AnlDatum) as Newsl_AnlDatum, 	   
...
iif(gekauftam is NULL, '30.12.1899', gekauftam) as gekauftam, 	   
...
iif(nofaxwerb_datum is NULL, '30.12.1899', nofaxwerb_datum) as nofaxwerb_datum, 	   
...
iif(noepostwerb_datum is NULL, '30.12.1899', noepostwerb_datum) as noepostwerb_datum, 	   
