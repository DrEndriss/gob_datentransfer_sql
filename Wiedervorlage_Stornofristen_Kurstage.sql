...
-- NEU AB 22.07.2022 Ausfall Kurse werden mir Exportiert - TK
from TERMINE t where t.NR in (select NR from KURSE  where BEGINN_DAT >= '01.01.2017' and (FACHB not in ('OR', 'VE','X') ))
